...
Aqui temos as taxas calculadas de 2020 de uma perspectiva gráfica. No eixo x estão as taxas calculadas para cada faixa etária e no eixo y estão as faixas etárias.
...
Gráficos das funções $l_x$ e $_nq_x$ são apresentados nas abas a seguir. COMENTAR OS RESULTADOS
...
Se lo=1, qual o significado da função lx? Interprete, neste caso, l20 e l60.
